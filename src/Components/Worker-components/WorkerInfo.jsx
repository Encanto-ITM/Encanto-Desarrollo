          ...
          <div className="mb-6">
            ...
            <div className="w-full bg-gray-100 border border-gray-300 rounded-lg mt-2 p-1">
              <p className="text-md text-gray-700 text-center">
                100 mts este, 75 norte de la Universidad de Costa Rica, Nances
                Esparza
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">
                  {worker.facebook || "No se han registra redes sociales"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="bg-purple text-white p-2 rounded-md">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">
                  {worker.instagram || "Pablito Barbers"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="bg-purple text-white p-2 rounded-md">
                ...
                <span className="text-gray-600">
                  {worker.twitter || "Pablito Barbers"}
                </span>
              </div>
            </div>
          </div>
