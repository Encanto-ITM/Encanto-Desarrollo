                    ...
                    <div className="p-6 relative">
                        ...
                        <div className='flex flex-col items-center text-center'>
                            ...
                            <div className='flex items-center text-center gap-3'>
                                <button onClick={openModal} className="rounded mt-4 border-2 border-blue text-blue p-2">Editar</button>
                                ...
                                <button onClick={handleOrders} className="rounded mt-4 border-2 border-blue text-blue p-2">Ver Ordenes</button>
                            </div>
                        </div>
                    </div>
